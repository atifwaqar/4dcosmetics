      ...
      <div class="cart-drawer-panel" role="dialog" aria-modal="true" aria-labelledby="cart-drawer-title">
        ...
        <footer class="cart-drawer-footer p-4 border-t bg-gray-50 space-y-3">
          ...
          <div class="cart-drawer-actions">
            <a class="flex items-center justify-center w-full rounded-xl h-12 text-base font-semibold bg-[#1E88E5] text-white hover:brightness-95" href="${state.opts.checkoutUrl}">Checkout</a>
          </div>
        </footer>
      </div>
