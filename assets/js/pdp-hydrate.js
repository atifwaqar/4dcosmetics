...
(function(){
  ...
  if(!window.CartDrawer){
    const s=document.createElement('script'); s.type='module'; s.src='/assets/js/cart-drawer.js';
    s.onload=()=>{ window.CartDrawer && window.CartDrawer.init({
      ...
      checkoutUrl:'/checkout', viewCartUrl:'/cart'
    }); };
