...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    applySEO({
      ...
      schemaBlocks: [{
        ...
        "offers": {
          ...
          "priceCurrency": product.price?.currency || product.currency,
    ...
    function applyVariant(v){
      ...
      if (mobileInfo) mobileInfo.textContent = `${v ? v.name : product.name} • ${StorefrontRuntime.formatPrice(priceNum, currency)}`;
